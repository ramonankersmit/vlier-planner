...
import { LOGO_IMAGE, SCREENSHOT_IMAGES } from "../assets/images";
...
const demoScreens = [
  {
    ...
    image: SCREENSHOT_IMAGES.weekoverzicht.src,
  ...
  },
  {
    ...
    image: SCREENSHOT_IMAGES.matrix.src,
  ...
  },
  {
    ...
    image: SCREENSHOT_IMAGES.uploads.src,
